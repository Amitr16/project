...
event tetsrun(address voter, uint price);
  function testNormalFlow() public {
    ...
    emit tetsrun(msg.sender, t.price());
...
//"Villa vid havet 10","12345","Singapore",1 , 4 ,0xEB9D7e6Cb4eef572CA51BAC2e9CCdaDFa20C534A,0xEB9D7e6Cb4eef572CA51BAC2e9CCdaDFa20C534A